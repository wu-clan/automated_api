...
class HTMLTestRunner(TemplateMixing):
    ...
    def __init__(self, stream=sys.stdout, verbosity=2, title=None, description=None, tester=None, save_last_run=True):
        self.stream = stream
        self.verbosity = verbosity
        self.save_last_run = save_last_run
        self.run_times = 0
    ...
    def _generate_report(self, result):
        ...
        report = env.get_template('report.html').render(
            ...
            total=str(result.success_count + result.failure_count + result.error_count + result.skip_count),
    ...
    def _generate_report_test(self, rows, cid, tid, n, t, o, e):
        ...
        row = tmpl % dict(
            ...
            style=n == 2 and 'errorCase' or (n == 1 and 'failCase' or n == 0 and 'passCase' or 'skipCase'),
            casename=name,
            desc=doc,
            runtime=runtime,
            script=script,
